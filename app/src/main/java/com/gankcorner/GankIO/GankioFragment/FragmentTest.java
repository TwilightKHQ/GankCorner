...
import com.gankcorner.Adapter.AdapterGankTest;
...
public class FragmentTest extends Fragment {
    ...
    private AdapterGankTest adapterGankTest;
...
//        mSwipeRefreshLayout = view.findViewById(R.id.swipe_refresh_layout);
    ...
    private void initView() {
        ...
        // 设置adapter
        adapterGankTest = new AdapterGankTest(R.layout.item_gank, mGankArticle);
        mRecyclerView.setAdapter(adapterGankTest);
//        //快要滑动到底部时自动加载更多
...
//                mSwipeRefreshLayout.setRefreshing(false);
    ...
    private void addData(GankArticleBean gankArticleBean) {
        ...
        adapterGankTest.notifyDataSetChanged();
//        if (mSwipeRefreshLayout.isRefreshing()){
//            adapterGankTest.refreshList(mGankArticle);
//        } else {
//            adapterGankTest.updateList(mGankArticle);
//        }
    }
