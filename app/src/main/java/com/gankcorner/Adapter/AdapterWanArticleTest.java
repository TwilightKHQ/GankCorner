...
public class AdapterWanArticleTest extends BaseQuickAdapter<WanArticle, BaseViewHolder> {


    public AdapterWanArticleTest(int layoutResId, @Nullable List<WanArticle> data) {
